...
import { coverStore ,noteBookStore } from './../../store'
import { goBack } from '../../publicFn';
const cover = coverStore()
...
const goNewNote = (selectIndex: number,text: string,  num: number = 0) => {
   ...
   notebook.addNoteBook({randomId, selectIndex,text,num})
...
<template>
    <div class="newlyBuilt">
        ...
        <div class="content">
            ...
            <div class="cover">
                <img :src="cover.imgUrl[selectIndex].url" alt="">
            </div>
        </div>
        <div class="selectCover">
            <p>选择封面</p>
            <van-swipe :loop="false" :width="100" :height="200" :show-indicators="false">
                <van-swipe-item v-for="(item, index) in cover.imgUrl" :key="item"
